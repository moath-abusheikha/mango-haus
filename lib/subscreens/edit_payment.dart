          ...
          child: Column(children: [
                            ...
                            child: Container(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: ((context, index) => GestureDetector(
                                      onTap: () async {
                                        var currPayment = await Provider.of<PaymentManager>(context,
                                                listen: false)
                                                  ...
                                                  if (diff <= currentReservation!.totalPrice) {
                                                    ...
                                                    showDialog(
                                                      ...
                                                      builder: (context) => AlertDialog(
                                                        content: Text('Amount Exceeds Total Price'),
                                                        actions: [
                                                          ElevatedButton(
                                                              onPressed: () {
                                                                controllers[index].clear();
            ...
            ElevatedButton(
                onPressed: () async {
                  ...
                  // print(resPaymentsDates);
                  // print(changedPayments);
                  // print(totalPayment);
                  // print(remaining);
                  // print(currentReservation?.guestName);
                  // print(currentReservation?.checkIn);
                  // print(currentReservation?.checkout);
                },
